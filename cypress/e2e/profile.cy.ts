...
describe("Page: /profile", () => {
  ...
  describe("No cookie, redirect to: /", () => {
    it("it should redirect to: /", () => {
      CypressTest.shouldRedirect(cy, `${url}/fr`);
    });
  });

  describe("Cookie invalid, redirect to: /", () => {
    it("it should redirect to: /", () => {
  ...
  describe("User not found, redirect to: /", () => {
    it("it should redirect to: /", () => {
  ...
  describe("Update profile without modifying anything", () => {
  ...
  describe("Send newPassword required", () => {
  ...
  describe("Send newPassword2 required", () => {
  ...
  describe("Send newPasswords not matching", () => {
  ...
  describe("Send oldPassword incorrect", () => {
  ...
  describe("Update profile with new username and new password", () => {
  ...
  describe("Update profile with new username", () => {
    it("it should update username and password", () => {
      cy.setCookie("user", data.validFrJwt);
